...
while valid == 1: # valid is a variable used to break the while loop when a valid input is entered
    form = int(input("""Specify the form of potential to be computed:\n
    ...
    if form == 1:
        ...
        def barrier(x, width, height):
            V_x = height * (theta(x) - theta(x - width))
            return V_x
        valid = 2
